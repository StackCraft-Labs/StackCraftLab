...
export default function AboutCTA() {
  ...
  return (
    <section ref={sectionRef} className="w-full bg-[#0a0a0a] py-24 sm:py-32 px-6 sm:px-12 md:px-[180px] relative overflow-hidden">
